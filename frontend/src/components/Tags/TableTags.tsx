...
import { fetch, update, deleteItem, setRefetch, deleteItemsByIds } from '../../stores/tags/tagsSlice'
...
const TableSampleTags = ({ filterItems, setFilterItems, filters, showGrid }) => {
  ...
  const { tags, loading, count, notify: tagsNotify, refetch } = useAppSelector((state) => state.tags)
  ...
  return (
    ...
    {filterItems && Array.isArray( filterItems ) && filterItems.length ?
      ...
      >
        ...
        {tags && Array.isArray(tags) && !showGrid && (
            <ListTags
                tags={tags}
                loading={loading}
