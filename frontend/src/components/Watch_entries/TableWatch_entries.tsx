...
import { fetch, update, deleteItem, setRefetch, deleteItemsByIds } from '../../stores/watch_entries/watch_entriesSlice'
...
import {loadColumns} from "./configureWatch_entriesCols";
...
const TableSampleWatch_entries = ({ filterItems, setFilterItems, filters, showGrid }) => {
  ...
  const { watch_entries, loading, count, notify: watch_entriesNotify, refetch } = useAppSelector((state) => state.watch_entries)
  ...
  useEffect(() => {
      if (watch_entriesNotify.showNotification) {
          notify(watch_entriesNotify.typeNotification, watch_entriesNotify.textNotification);
      }
  }, [watch_entriesNotify.showNotification]);
...
export default TableSampleWatch_entries
