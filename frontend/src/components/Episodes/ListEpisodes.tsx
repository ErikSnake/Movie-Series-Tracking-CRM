...
const ListEpisodes = ({ episodes, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                        ...
                        <div className={`flex ${bgColor} ${corners !== 'rounded-full' ? corners : 'rounded-3xl'}  dark:bg-dark-900  border  border-gray-600  items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.seasonsOneListFormatter(item.season) }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs   text-gray-500 '}>EpisodeNumber</p>
                                <p className={'line-clamp-2'}>{ item.episode_number }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs   text-gray-500 '}>EpisodeTitle</p>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs   text-gray-500 '}>AirDate</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.dateTimeFormatter(item.air_date) }</p>
                            </div>
