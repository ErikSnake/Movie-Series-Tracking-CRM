...
import { fetch, update, deleteItem, setRefetch, deleteItemsByIds } from '../../stores/seasons/seasonsSlice'
...
const TableSampleSeasons = ({ filterItems, setFilterItems, filters, showGrid }) => {
  ...
  const { seasons, loading, count, notify: seasonsNotify, refetch } = useAppSelector((state) => state.seasons)
