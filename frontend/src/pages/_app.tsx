...
function MyApp({ Component, pageProps }: AppPropsWithLayout) {
  ...
  const description = "Track movies and series episodes by franchise with statuses, ratings, and a next-to-watch queue."
  const url = "https://flatlogic.com/"
  const image = "https://project-screens.s3.amazonaws.com/screenshots/38525/app-hero-20260217-152029.png"
