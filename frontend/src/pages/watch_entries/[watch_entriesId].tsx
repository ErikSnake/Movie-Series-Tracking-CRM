...
const EditWatch_entries = () => {
  ...
  const { watch_entriesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: watch_entriesId }))
  }, [watch_entriesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: watch_entriesId, data }))
...
EditWatch_entries.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
...
export default EditWatch_entries
