            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>User</p>
                        ...
                        <p>{attachments?.user?.firstName ?? 'No data'}</p>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Title</p>
                        ...
                        <p>{attachments?.title?.name ?? 'No data'}</p>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Episode</p>
                        ...
                        <p>{attachments?.episode?.name ?? 'No data'}</p>
                ...
                <FormField label='Multi Text' hasTextareaHeight>
                  <textarea className={'w-full'} disabled value={attachments?.description} />
                </FormField>
                ...
                <div className={'mb-4'}>
                    ...
                    <p>{attachments?.category ?? 'No data'}</p>
                </div>
                ...
                <FormField label='AttachedAt'>
                    {attachments.attached_at ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={attachments.attached_at ?
                        new Date(
                          dayjs(attachments.attached_at).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
                    /> : <p>No AttachedAt</p>}
