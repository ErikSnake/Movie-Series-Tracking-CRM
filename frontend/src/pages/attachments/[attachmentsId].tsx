...
const EditAttachments = () => {
  ...
  const { attachmentsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: attachmentsId }))
  }, [attachmentsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: attachmentsId, data }))
...
EditAttachments.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
