...
const EditTitle_tags = () => {
  ...
  const { title_tagsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: title_tagsId }))
  }, [title_tagsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: title_tagsId, data }))
...
EditTitle_tags.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
