...
import { create } from '../../stores/title_tags/title_tagsSlice'
...
Title_tagsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
        
          permission={'CREATE_TITLE_TAGS'}
