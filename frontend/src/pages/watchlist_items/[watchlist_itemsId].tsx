...
const EditWatchlist_items = () => {
  ...
  const { watchlist_itemsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: watchlist_itemsId }))
  }, [watchlist_itemsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: watchlist_itemsId, data }))
...
EditWatchlist_items.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
...
export default EditWatchlist_items
