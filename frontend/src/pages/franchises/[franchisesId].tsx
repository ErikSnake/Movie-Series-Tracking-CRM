...
const EditFranchises = () => {
  ...
  const { franchisesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: franchisesId }))
  }, [franchisesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: franchisesId, data }))
...
EditFranchises.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
