...
const EditEpisodes = () => {
  ...
  const { episodesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: episodesId }))
  }, [episodesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: episodesId, data }))
...
EditEpisodes.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
