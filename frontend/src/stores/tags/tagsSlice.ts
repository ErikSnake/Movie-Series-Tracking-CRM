...
export const deleteItem = createAsyncThunk('tags/deleteTags', async (id: string, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('tags/createTags', async (data: any, { rejectWithValue }) => {
    try {
...
export const update = createAsyncThunk('tags/updateTags', async (payload: any, { rejectWithValue }) => {
    try {
