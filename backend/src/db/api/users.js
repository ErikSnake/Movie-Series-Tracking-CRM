...
module.exports = class UsersDBApi {
    ...
    static async findBy(where, options) {
        ...
        output.watch_entries_user = await users.getWatch_entries_user({
            transaction
        });
        
        
        output.watchlist_items_user = await users.getWatchlist_items_user({
            transaction
        });
        ...
        output.attachments_user = await users.getAttachments_user({
            transaction
        });
